...
class String extends React.Component {
    constructor() {
        ...
        this.handleChange = (event) => {
            ...
            if (dispatch) {
                (_a = dispatch((0, newValue_1.newStringValueAsync)(path, value, item))) === null || _a === void 0 ? void 0 : _a.then(newState => onAnswerChange(newState, path, item, { valueString: value }));
            }
    ...
    render() {
        ...
        return (React.createElement("div", { className: "page_refero__component page_refero__component_string" },
            React.createElement(validation_1.default, Object.assign({}, this.props),
                React.createElement(safe_input_field_1.default, { type: "text", id: (0, index_1.getId)(this.props.id), inputName: (0, index_1.getId)(this.props.id), value: (0, index_1.getStringValue)(answer), onChangeValidator: this.validateText, showLabel: true, label: React.createElement(label_1.default, { item: item, onRenderMarkdown: onRenderMarkdown, questionnaire: questionnaire, resources: resources }), subLabel: subLabelText ? React.createElement(sublabel_1.default, { subLabelText: subLabelText }) : undefined, isRequired: (0, index_1.isRequired)(item), placeholder: (0, extension_1.getPlaceholder)(item), minLength: (0, extension_1.getMinLengthExtensionValue)(item), maxLength: (0, index_1.getMaxLength)(item), extension: item.extension, onChange: (event) => {
                        this.handleChange(event);
