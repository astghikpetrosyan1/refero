...
const DateYearInput = (props) => {
    ...
    const getYear = () => {
        ...
        if ((_a = props.answer) === null || _a === void 0 ? void 0 : _a.valueDate) {
            return (_b = props.answer) === null || _b === void 0 ? void 0 : _b.valueDate;
        }
        return answerState;
    };
    React.useEffect(() => {
        var _a, _b;
        props.answer ? setAnswerState(Number((_a = props.answer) === null || _a === void 0 ? void 0 : _a.valueDate)) : setAnswerState((_b = getYear()) === null || _b === void 0 ? void 0 : _b[0]);
    }, [props.answer]);
