...
class OpenChoice extends React.Component {
    constructor() {
        ...
        this.renderCheckbox = (options) => {
            var _a;
            const showChoiceImage = this.props.extension ? (_a = this.props.extension.find((extension) => extension.url === help_1.IExtentionType.choiceImage)) === null || _a === void 0 ? void 0 : _a.valueBoolean : false;
