...
class OpenChoice extends React.Component {
    constructor() {
        ...
        this.renderCheckbox = (options) => {
            ...
            return (React.createElement(checkbox_view_1.default, Object.assign({ options: options, id: this.props.id, showChoiceImage: showChoiceImage, handleChange: this.handleCheckboxChange, selected: this.getValue(this.props.item, this.props.answer), renderOpenField: () => this.renderTextField(), onRenderMarkdown: this.props.onRenderMarkdown }, this.props), this.props.children));
        };
        ...
        this.renderRadio = (options) => {
            var _a;
            const _b = this.props, { item, resources, containedResources, children, id, answer, repeatButton } = _b, rest = tslib_1.__rest(_b, ["item", "resources", "containedResources", "children", "id", "answer", "repeatButton"]);
            const showChoiceImage = item.extension ? (_a = item.extension.find((extension) => extension.url === help_1.IExtentionType.choiceImage)) === null || _a === void 0 ? void 0 : _a.valueBoolean : false;
            return (React.createElement(radio_view_1.default, Object.assign({ options: options, item: item, showChoiceImage: showChoiceImage, getErrorMessage: (value) => (0, choice_1.getErrorMessage)(item, value, resources, containedResources), handleChange: this.handleChange, validateInput: (value) => (0, choice_1.validateInput)(item, value, containedResources, resources), id: id, selected: this.getValue(item, answer), repeatButton: repeatButton, renderOpenField: () => this.renderTextField(), answer: answer, onRenderMarkdown: this.props.onRenderMarkdown }, rest), children));
        };
