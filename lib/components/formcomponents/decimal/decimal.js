...
const numberSafeInputField_1 = tslib_1.__importDefault(require("../../util/inputWrapper/numberSafeInputField"));
class Decimal extends React.Component {
    ...
    render() {
        ...
        const type = (0, extension_1.getItemTypeExtensionValue)(item);
        const max = (0, extension_1.getMaxValueExtensionValue)(item);
        const min = (0, extension_1.getMinValueExtensionValue)(item);
        const fixes = {
            sufix: type === 'range' ? (React.createElement("span", null, max)) : null,
            prefix: type === 'range' ? (React.createElement("span", null, min)) : null
        };
        ...
        return (React.createElement("div", { className: "page_refero__component page_refero__component_decimal" },
            React.createElement(validation_1.default, Object.assign({}, this.props),
                React.createElement(numberSafeInputField_1.default, Object.assign({ isValidationHidden: false, type: type, id: (0, index_1.getId)(this.props.id), inputName: (0, index_1.getId)(this.props.id), value: value ? value + '' : '', showLabel: true, label: React.createElement(label_1.default, { item: item, onRenderMarkdown: onRenderMarkdown, questionnaire: this.props.questionnaire, resources: this.props.resources }), subLabel: subLabelText ? React.createElement(sublabel_1.default, { subLabelText: subLabelText }) : undefined, isRequired: (0, index_1.isRequired)(item), placeholder: (0, extension_1.getPlaceholder)(item), max: max, min: min, errorMessage: (0, extension_1.getValidationTextExtension)(item), pattern: (0, index_1.getDecimalPattern)(item), className: "page_refero__input", helpButton: this.props.renderHelpButton(), helpElement: this.props.renderHelpElement(), validateOnExternalUpdate: true, onChange: this.handleChange }, fixes))),
