...
class Choice extends React.Component {
    constructor(props) {
        ...
        this.renderCheckbox = (options) => {
            return (React.createElement(checkbox_view_1.default, Object.assign({ choiceImage: this.props.choiceImage || false, options: options, id: this.props.id, handleChange: this.handleCheckboxChange, selected: this.getValue(this.props.item, this.props.answer), onRenderMarkdown: this.props.onRenderMarkdown }, this.props), this.props.children));
        };
