...
const CheckboxView = (_a) => {
    var { options, item, questionnaire, id, handleChange, selected, resources, children, repeatButton, renderDeleteButton, renderHelpButton, renderHelpElement, showChoiceImage, onRenderMarkdown } = _a, other = tslib_1.__rest(_a, ["options", "item", "questionnaire", "id", "handleChange", "selected", "resources", "children", "repeatButton", "renderDeleteButton", "renderHelpButton", "renderHelpElement", "showChoiceImage", "onRenderMarkdown"]);
    if (!options) {
        return null;
    }
    ...
    return (React.createElement("div", { className: "page_refero__component page_refero__component_choice page_refero__component_choice_checkbox" },
        React.createElement(react_collapse_1.Collapse, { isOpened: true },
            React.createElement(validation_1.default, Object.assign({}, other),
                React.createElement(checkbox_group_1.default, Object.assign({}, item, { legend: React.createElement(label_1.default, { item: item, onRenderMarkdown: onRenderMarkdown, questionnaire: questionnaire, resources: resources }), subLabel: subLabelText ? React.createElement(sublabel_1.default, { subLabelText: subLabelText }) : undefined, checkboxes: checkboxes, handleChange: handleChange, isRequired: (0, index_1.isRequired)(item), id: (0, index_1.getId)(id), max: (0, extension_1.getMaxOccursExtensionValue)(item), min: (0, extension_1.getMinOccursExtensionValue)(item), errorMessage: (0, extension_1.getValidationTextExtension)(item), helpButton: renderHelpButton(), helpElement: renderHelpElement(), fieldsetClassName: item.choiceImage ? 'image-container' : '', validateOnExternalUpdate: true, isStyleBlue: true }, other))),
