...
const RadioView = (_a) => {
    var { options, item, questionnaire, id, handleChange, selected, validateInput, resources, children, getErrorMessage, repeatButton, renderDeleteButton, renderHelpButton, renderHelpElement, showChoiceImage, onRenderMarkdown } = _a, other = tslib_1.__rest(_a, ["options", "item", "questionnaire", "id", "handleChange", "selected", "validateInput", "resources", "children", "getErrorMessage", "repeatButton", "renderDeleteButton", "renderHelpButton", "renderHelpElement", "showChoiceImage", "onRenderMarkdown"]);
    if (!options) {
        return null;
    }
