...
function getItemTypeExtensionValue(item) {
    const extension = getExtension(extensions_1.default.isSlider, item);
    if (extension && extension.valueBoolean !== null && extension && extension.valueBoolean !== undefined && extension.valueBoolean) {
        return 'range';
    }
    return 'number';
}
exports.getItemTypeExtensionValue = getItemTypeExtensionValue;
...
function getQuestionnaireHiddenExtensionValue(item) {
    var _a;
    const isHidden = (_a = item.extension) === null || _a === void 0 ? void 0 : _a.some(ext => (ext.url === extensions_1.default.QUESTIONNAIRE_HIDDEN ||
        ext.url === extensions_1.default.QUESTIONNAIRE_HIDDEN_ON_WEB) &&
        ext.valueBoolean === true);
    return isHidden !== null && isHidden !== void 0 ? isHidden : false;
}
